                ...
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <div style="border-radius:10px; color:#1D5D9B; font-size:15px; ">
                            Nomor Kegiatan : {{ $payment->nomor_payment }}
                        </div>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td colspan="3">
                        <div style="color:black; font-size:18px; ">
                            No. Work Order : {{ $payment->nomor_wo}}
                        </div>
                        <div style="color:black; font-size:18px; ">
                            Customer : {{ $payment->nama_customer }}
                        </div>
                        <div style="color:black; font-size:18px; ">
                            Tanggal / Waktu : {{ $payment->created_at }}
                        </div>
                    </td>
                    <td colspan="3">
            ...
            <table class="table table-borderless" style="border:1px solid #0B4269; padding:10px; border-radius:10px; font-size:11px;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td>{{ number_format($total_biaya, 2, ',', '.') }}</td>
                    </tr>
                </tfoot>
            </table>
            <br><br>
