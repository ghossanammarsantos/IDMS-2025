                                ...
                                <div class="card-content">
                                    <div class="card-body p-1">
                                        ...
                                        <form id="addSurveyForm" method="post" action="{{ route('survey.store_detail') }}">
                                            ...
                                            <div class="form-group">
                                                <label for="noContainerSelect">Pilih Kegiatan Container 1</label>
                                                <select class="select2 form-control"
                                                    multiple="multiple" name="kegiatan1[]"
                                                    id="containerSelect1"
                                                    style="width:100%;">
                                            ...
                                            <div class="form-group">
                                                <label for="noContainerSelect">Pilih Kegiatan Container 2</label>
                                                <select class="select2 form-control"
                                                    multiple="multiple" name="kegiatan2[]"
                                                    id="containerSelect2"
                                                    style="width:100%;">
                                                    @foreach ($tarif_list as $data)
                                                        <option value="{{ $data->nama_jasa }}">{{ $data->nama_jasa }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="no_bldo" class="form-control" placeholder="Masukkan nomor BL/DO" name="no_bldo">
                                            </div>

                                            <div class="form-group">
                                                <label for="no_truck">Nomor Truck</label>
                                                <input type="text" id="no_truck" class="form-control" placeholder="Masukkan nomor truck" name="no_truck">
                                            </div>
                                            <div class="form-group">
                                                <label for="driver">Nama Driver</label>
                                                <input type="text" id="driver" class="form-control" placeholder="Masukkan nama driver" name="driver">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="noContainerSelect" name="pic">
                                                    ...
                                                    <option value="Hasan">Jaka</option>
                                                </select>
                                            </div>
