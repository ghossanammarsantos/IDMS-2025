...
<head>
    ...
    <title>Equipment Intercharge Receipt OUT</title>
    <style>
        body {
    ...
    <div class="row">
        <div class="col-12">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <div style="padding-top:10px; border-radius:10px; color:#1D5D9B; font-size:30px; ">
                            <u>Equipment Intercharge Receipt (OUT)</u>
                        </div>
                        <br>
                        <div>
                            <img src="https://barcode.tec-it.com/barcode.ashx?data={{ $surveyout->kode_surveyout }}&code=Code128&dpi=96" alt="Barcode" />
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table style="margin-top:0px;">
                <tr>
                    <td colspan="3">
                        ...
                        <div style="color:black; font-size:12px; ">
                            Tanggal / Waktu Survey : {{ $surveyout->surveyout_time }}
                        </div>
                        <div style="color:black; font-size:12px; ">
                            Shipper :
                        </div>
                    ...
                    <td colspan="3">
                        <div style="color:black; font-size:12px; ">
                            No BL / DO : {{ $surveyout->no_bldo }}
                        </div>
                        <div style="color:black; font-size:12px; ">
                            Driver : {{ $surveyout->driver }}
                        </div>
                        <div style="color:black; font-size:12px; ">
                            No Truck : {{ $surveyout->no_truck }}
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-borderless" style="border:1px solid #0B4269; padding:10px; border-radius:10px; font-size:11px;">
                ...
                <tbody>
                    <tr>
                        <td>{{ $surveyout->no_container }}</td>
                        <td>{{ $surveyout->size_type }}</td>
                    </tr>
                </tbody>
            </table>
            <br><br>
