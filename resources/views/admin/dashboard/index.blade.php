                            ...
                            <div class="card-content">
                                ...
                                <div class="p-1 text-center">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                        <div class="p-1 text-center">
                                            <div>
                                                <h3 class="font-large-1 grey darken-1 text-bold-400">{{ $dataTotalToday }}
                                                </h3>
                                                <span class="font-medium-3 grey darken-1">Kegiatan / Hari
                                                    {{ $currentDay }}</span>
                                            </div>
                                            <div class="card-content overflow-hidden">
                                                ...
                                                <div class="row justify-content-between">
                                                    <div class="col-6 border-right-grey border-right-lighten-2 pr-2">
                                                        ...
                                                        <span class="font-medium-3 grey darken-1"><i
                                                                class="ft-chevron-up primary"></i> IN</span>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <h3 class="primary text-bold-400">{{ $dataIn20ft }}</h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-up primary"></i> 20ft</span>
                                                            </div>
                                                            <div class="col-6">
                                                                <h3 class="primary text-bold-400">{{ $dataIn40ft }}</h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-up primary"></i> 40ft</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        ...
                                                        <span class="font-medium-3 grey darken-1"><i
                                                                class="ft-chevron-down primary"></i> OUT</span>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <h3 class="primary text-bold-400">{{ $dataOut20ft }}</h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-down primary"></i> 20ft</span>
                                                            </div>
                                                            <div class="col-6">
                                                                <h3 class="primary text-bold-400">{{ $dataOut40ft }}</h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-down primary"></i> 40ft</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="p-1 text-center">
                                            <div>
                                                <h3 class="font-large-1 grey darken-1 text-bold-400">{{ $dataTotalMonth }}
                                                </h3>
                                                <span class="font-medium-3 grey darken-1">Kegiatan / Bulan
                                            ...
                                            <div class="card-content overflow-hidden">
                                                ...
                                                <ul class="list-inline clearfix mb-0">
                                                    <li class="border-right-grey border-right-lighten-2 pr-2">
                                                        ...
                                                        <span class="font-medium-3 grey darken-1"><i
                                                                class="ft-chevron-up danger"></i> IN</span>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <h3 class="danger text-bold-400">{{ $dataInMonth20ft }}
                                                                </h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-up danger"></i> 20ft</span>
                                                            </div>
                                                            <div class="col-6">
                                                                <h3 class="danger text-bold-400">{{ $dataInMonth40ft }}
                                                                </h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-up danger"></i> 40ft</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="pl-2">
                                                        ...
                                                        <span class="font-medium-3 grey darken-1"><i
                                                                class="ft-chevron-down danger"></i> OUT</span>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <h3 class="danger text-bold-400">{{ $dataOutMonth20ft }}
                                                                </h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-down danger"></i> 20ft</span>
                                                            </div>
                                                            <div class="col-6">
                                                                <h3 class="danger text-bold-400">{{ $dataOutMonth40ft }}
                                                                </h3>
                                                                <span class="font-medium-3 grey darken-1"><i
                                                                        class="ft-chevron-down danger"></i> 40ft</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                        ...
                        <div class="card card-inverse bg-white">
                            <div class="card-content">
                                <div class="card-body sales-growth-chart">
                                    ...
                                    <canvas id="monthly-out" class="height-250"
                                        style="width: 100%; height: 250px;"></canvas>
                                </div>
                            </div>
                            <div class="card-footer text-center">
                                <div class="chart-stats mt-1 dark">
                                    <a href="#" class="btn bg-dark bg-darken-3 mr-1 white">Details <i
                                            class="ft-bar-chart"></i></a> for the last year.
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-inverse bg-white">
                            <div class="card-content">
                                <div class="card-body sales-growth-chart">
                                    ...
                                    <canvas id="monthly-in" class="height-250"
                                        style="width: 100%; height: 250px;"></canvas>
                                </div>
                            </div>
                            <div class="card-footer text-center">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <ul class="list-inline text-center pt-2 m-0">
                                    <h2>Repairing</h2>
                                    <li class="mr-1">
                                        <h6><i class="ft-circle warning"></i> <span class="grey darken-1">Remaining</span>
                                        </h6>
                                    </li>
                                    <li class="mr-1">
                                        <h6><i class="ft-circle success"></i> <span class="grey darken-1">Completed</span>
                                        </h6>
                                    </li>
                                </ul>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-3 text-center">
                                        ...
                                        <div class="progress mt-2" style="height: 7px;">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                style="width: {{ $totalProjects > 0 ? ($completedTasks / $totalProjects) * 100 : 0 }}%"
                                                aria-valuenow="{{ $completedTasks }}" aria-valuemin="0"
                                    ...
                                    <div class="col-3 text-center">
                                        ...
                                        <div class="progress mt-2" style="height: 7px;">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                style="width: {{ $totalTasks > 0 ? ($remainingTasks / $totalTasks) * 100 : 0 }}%"
                                                aria-valuenow="{{ $remainingTasks }}" aria-valuemin="0"
                                    ...
                                    <div class="col-3 text-center">
                                        ...
                                        <div class="progress mt-2" style="height: 7px;">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                style="width: {{ $completedTasks > 0 ? ($completedTasks / $totalProjects) * 100 : 0 }}%"
                                                aria-valuenow="{{ $completedTasks }}" aria-valuemin="0"
                                                aria-valuemax="{{ $totalProjects }}"></div>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            labels.forEach((label, index) => {
                var monthKey = new Date(new Date().getFullYear(), index, 1).toISOString().substr(0,
                    7); // Create YYYY-MM key for the current year
                if (dataMap[monthKey]) {
